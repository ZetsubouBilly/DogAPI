    ...
    render() {
        return (
            <div className="search__header">
                   ...
                   <Link to="/likes"><a className="search__rating" href=""><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="search__rating" href=""><svg width="30" height="26" viewBox="0 0 30 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="search__rating" href=""><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
